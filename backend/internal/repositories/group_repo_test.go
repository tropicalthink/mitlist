...
func TestGroupRepository_CreateGroup(t *testing.T) {
	...
	mock.ExpectExec("INSERT INTO groups").
		WithArgs(pgxmock.AnyArg(), group.Name, group.Description, group.CreatedBy, pgxmock.AnyArg(), pgxmock.AnyArg()).
...
func TestGroupRepository_GetGroupByID(t *testing.T) {
	...
	rows := pgxmock.NewRows([]string{"id", "name", "description", "created_by", "created_at", "updated_at"}).
		AddRow(id, "Home", nil, fixedUUID(), fixedTime(), fixedTime())
...
func TestGroupRepository_ListGroupsByUser(t *testing.T) {
	...
	rows := pgxmock.NewRows([]string{"id", "name", "description", "created_by", "created_at", "updated_at"}).
		AddRow(fixedUUID(), "Home", nil, userID, fixedTime(), fixedTime())
...
func TestGroupRepository_UpdateGroup(t *testing.T) {
	...
	mock.ExpectExec("UPDATE groups SET").
		WithArgs("New Name", pgxmock.AnyArg(), pgxmock.AnyArg(), id).
