...
func (h *ListHandler) ArchiveList(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.service.SetListArchived(r.Context(), user, id, true); err != nil {
		api.RespondError(w, err)
		return
	}
	w.WriteHeader(http.StatusNoContent)
...
func (h *ListHandler) UnarchiveList(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.service.SetListArchived(r.Context(), user, id, false); err != nil {
		api.RespondError(w, err)
		return
	}
	w.WriteHeader(http.StatusNoContent)
...
func (h *ListHandler) ClaimItem(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.service.ClaimItem(r.Context(), user, listID, itemID); err != nil {
		api.RespondError(w, err)
		return
	}
	w.WriteHeader(http.StatusNoContent)
...
func (h *ListHandler) UnclaimItem(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.service.UnclaimItem(r.Context(), user, listID, itemID); err != nil {
		api.RespondError(w, err)
		return
	}
	w.WriteHeader(http.StatusNoContent)
