...
class MitlistTypography {
  ...
  static TextTheme get lightTextTheme => TextTheme(
        ...
        titleMedium: _grotesk(size: 16, weight: FontWeight.w600, height: 24 / 16, spacing: 0.15),
        titleSmall: _grotesk(size: 14, weight: FontWeight.w600, height: 20 / 14, spacing: 0.1),
        ...
        labelLarge: _grotesk(size: 14, weight: FontWeight.w600, height: 20 / 14, spacing: 0.1),
        labelMedium: _grotesk(size: 12, weight: FontWeight.w500, height: 16 / 12, spacing: 0.5, color: MitlistColors.textSecondary),
        labelSmall: _grotesk(size: 11, weight: FontWeight.w500, height: 16 / 11, spacing: 0.5, color: MitlistColors.textTertiary),
      );
  ...
  static TextTheme get darkTextTheme => TextTheme(
        ...
        titleMedium: _grotesk(size: 16, weight: FontWeight.w600, height: 24 / 16, spacing: 0.15, color: MitlistColors.surfaceSoft),
        titleSmall: _grotesk(size: 14, weight: FontWeight.w600, height: 20 / 14, spacing: 0.1, color: MitlistColors.surfaceSoft),
        ...
        labelLarge: _grotesk(size: 14, weight: FontWeight.w600, height: 20 / 14, spacing: 0.1, color: MitlistColors.surfaceSoft),
        labelMedium: _grotesk(size: 12, weight: FontWeight.w500, height: 16 / 12, spacing: 0.5, color: MitlistColors.neutral300),
        labelSmall: _grotesk(size: 11, weight: FontWeight.w500, height: 16 / 11, spacing: 0.5, color: MitlistColors.neutral400),
      );
